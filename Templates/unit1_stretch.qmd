...
- [P4DS: Chapter 14.2 - 14.3 Labels, titles, contextual info, annotations](https://pandas.pydata.org/pandas-docs/stable/getting_started/intro_tutorials/01_table_oriented.html)
...
1. __Reproduce the chart Elliot using the data from the `names_year.csv` file. You may not get it exact, but spend a couple of hours getting it as close as you can__
...
1. Have the `unit1_stretch` file open in VS Code and nothing else
